...
CREATE TABLE `categorys` (
  ...
  `category` varchar(32) CHARACTER SET utf8 NOT NULL COMMENT '小说类型',
  PRIMARY KEY (`id`),
...
CREATE TABLE `chapters` (
  ...
  `origin_url` varchar(255) NOT NULL COMMENT '来源url',
...
) ENGINE=InnoDB AUTO_INCREMENT=236530 DEFAULT CHARSET=utf8mb4 COMMENT='章节表';
...
) ENGINE=InnoDB AUTO_INCREMENT=236090 DEFAULT CHARSET=utf8mb4;
